package com.study.spring.base.bean.aop;
...
// @Aspect 需要 spring-aspects 相关依赖 aspectjweaver.jar 和 assertj-core-3.13.2.jar
@Aspect
@Component
public class Log {
...
//            5、*(..):最后这个星号表示方法名，*号表示所有的方法，后面括弧里面表示方法的参数，两个句点表示任何参数。
    @Pointcut("execution(* com.study.spring.base.bean..*.*(..))")
